...
//		String password = "shree12345";
//		String encodedPassword = passwordEncoder.encode(password);
//		
//		User newUser = User.builder().email("shree@gmail.com").password(encodedPassword).build();
		
		String password = "sample123";
		String encodedPassword = passwordEncoder.encode(password);
		
		User newUser = User.builder().email("sample@gmail.com").password(encodedPassword).build();
